...
V1.10 增加邮件提醒功能，漏洞报告提交超过5天后自动提醒提交者是否修复漏洞。

V1.11 增加自定义模板上传，需要申请wps开发者平台权限。

V1.12 增加报告分享外链方式进行分享，无需登录即可查看报告内容。

V1.13 增加防漏扫功能，避免Awvs，Nessus等一些开源软件进行漏洞扫描。

V1.14 增加认证访问链，自动形成整条认证访问链，行为操作链。

V1.15 优化post提交内容，进行RSA加密进行提交到后端。

V1.16 优化页面弹出消息提示层。

V1.17 增加附件管理，方便团队协作共享文档，文件等。

V1.18 增加数据库备份，方便数据迁移。
